    ...
    return (
        <div className='struktur-page'>
            ...
            <div className='struktur-loc'>
                <Link className='text-decoration-none beranda link-beranda' id='link-beranda' to="/">Beranda</Link>
                <p className=''>{">"}</p>
                <Link className='text-decoration-none lokasi'>Sejarah Perkembangan SMK Negeri 1 Cimahi</Link>
            </div>
            <Row className='main-struktur'>
                <Col className='struktur'>
                    <Col>
                        <Col>
                            <h1 className='fw-bold text-center sejarah-title'>Sejarah Pengembangan</h1>
                    ...
                    <VisiMisi />
                    <Col className='struktur-container'>
                        <Col className=''>
